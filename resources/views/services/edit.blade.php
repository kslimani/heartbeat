...
@section('main')
    ...
    <div class="mb-3"><h3>{{ __('app.services_edit') }}</h3></div>
    ...
    <form method="POST" action="{{ route('services.update', ['service' => $service->id]) }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="label" type="label" class="form-control{{ $errors->has('label') ? ' is-invalid' : '' }}" name="label" value="{{ old('label', $service->label) }}" required autocomplete="label">
